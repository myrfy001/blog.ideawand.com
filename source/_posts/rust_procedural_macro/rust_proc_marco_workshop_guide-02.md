---
title: Rust过程宏系列教程(2)--实现proc-macro-workshop项目之Builder题目
date: 2021-03-24 22:09:26
tags: Rust,过程宏,proc-macro,proc-macro-workshop
---
...
好了，不废话了，准备好一台电脑，我们从第一个过程宏挑战任务`builder`开始，每一关对应的视频教程我也放在下面了，点击【阅读原文】就可以看到所有的视频教程。
...
![deriveInput类型和结构体的对应关系](/images/rust_procedural_macro/derive_input_mapping.png)
